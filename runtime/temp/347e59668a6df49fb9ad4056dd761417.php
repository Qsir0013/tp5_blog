<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\phpStudy\PHPTutorial\WWW\guan\public/../application/admin\view\article\edit.html";i:1524649725;s:72:"E:\phpStudy\PHPTutorial\WWW\guan\application\admin\view\public\comm.html";i:1524706452;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
								...
								<?php if($find['img'] == ''): ?>
								<img style="width:200px" src="/zw.jpg" />
								<?php else: ?>
								<img style="width:200px" src="/<?php echo $find['img']; ?>" />
								<?php endif; ?>
								</td>
                            </tr>
                            <tr>
