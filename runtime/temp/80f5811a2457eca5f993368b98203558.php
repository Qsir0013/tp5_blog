        ...
        <div id="divAll">
            <div id="divPage">
                <div id="divMiddle">
                    ...
                    <div id="divMain">
                    <?php if(is_array($searchArticle) || $searchArticle instanceof \think\Collection || $searchArticle instanceof \think\Paginator): $i = 0; $__LIST__ = $searchArticle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                        <div class="post pagebar">
                            <?php echo $searchArticle->render(); ?>
                            共<?php echo $searchArticle->total(); ?>条 <?php echo $searchArticle->currentPage(); ?>/<?php echo $searchArticle->lastPage(); ?> 页
                        </div>
                    </div>
                    <div id="divSidebar">
