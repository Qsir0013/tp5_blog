<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"E:\phpStudy\PHPTutorial\WWW\guan\public/../application/index\view\my\index.html";i:1522400134;s:71:"E:\phpStudy\PHPTutorial\WWW\guan\application\index\view\public\nav.html";i:1522400134;s:73:"E:\phpStudy\PHPTutorial\WWW\guan\application\index\view\public\right.html";i:1522400309;s:71:"E:\phpStudy\PHPTutorial\WWW\guan\application\index\view\public\fot.html";i:1522400134;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="zh-CN" lang="zh-CN">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta http-equiv="Content-Language" content="zh-CN" />
        <meta name="keywords" content="<?php echo $nav['3']['keywords']; ?>" />
        <meta name="description" content="<?php echo $nav['3']['des']; ?>"
        />
        <title>
            Qsir的博客__<?php echo $nav['3']['catename']; ?>
        </title>
                ...
                <div id="divMiddle">
                    ...
                    <?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <div class="post multi-post cate4 auth1">
                            ...
                            <h2 class="post-title">
                                <a href="<?php echo url('My/read',array('id'=>$vo['id'])); ?>">
                                    <?php echo $vo['title']; ?>
                                </a>
                            </h2>
                            <div class="post-body">
                                ...
                                <span class="tags">
                                    <?php 
                                        ...
                                        foreach($targs as $k=>$v){
                                            echo "<a href='/guan/index.php/index/base/search/targs/$v'>$v</a>&nbsp;&nbsp;";
                                        } 
                                    ?> 
                                </span>
                            </h5>
                            <h6 class="post-footer">
                                ...
                                <a href="<?php echo url('Base/read',array('id'=>$vo['id'])); ?>">
                                    阅读全文 >
                                </a>
                            </h6>
                        </div>
